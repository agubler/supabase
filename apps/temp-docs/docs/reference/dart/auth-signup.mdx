...
If you are using Flutter, you can sign up with OAuth providers using the [`signInWithOAuth()`](/docs/reference/flutter/auth-signinwithoauth) method available on `supabase_flutter`.
