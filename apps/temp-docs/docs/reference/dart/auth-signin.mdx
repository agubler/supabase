...
- If you are looking to sign users in with OAuth in Flutter apps, go to [`signInWithOAuth()`](/docs/reference/flutter/auth-signinwithoauth).
...
If you are looking to sign in a user via OAuth on Flutter app, go to [`signInWithProvider()`](/docs/reference/flutter/auth-signinwithprovider).
