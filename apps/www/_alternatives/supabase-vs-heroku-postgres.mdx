...
- Realtime - [subscribe to data changes via websockets](https://supabase.com/docs/reference/flutter/subscribe)
...
- Supabase is more than just the raw database, it also comes with:
  ...
  - [Realtime API](https://supabase.com/docs/reference/flutter/subscribe) is useful for when you want to subscribe to changes to your database over websockets.
