...
Thanks entirely to [@dshukertjr](https://twitter.com/dshukertjr), we now have in-depth [reference Dart documentation](/docs/reference/flutter/installing) for CRUD, Auth, Realtime and more!
