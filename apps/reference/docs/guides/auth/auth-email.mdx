...
When your user signs in, call [signInWithPassword()](/docs/reference/flutter/auth-signinwithpassword) with their email address and password:
...
When your user signs out, call [signOut()](/docs/reference/flutter/auth-signout) to remove them from the browser session and any objects from localStorage:
